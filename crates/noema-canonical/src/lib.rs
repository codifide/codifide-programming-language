//! Noema canonical form — Rust implementation.
//!
//! This crate is a second, independent implementation of the Noema canonical
...
//! canonical form is the stablest part of Noema and the part where
